describe("datepickerDirective", function () {
    ...
    it("Should be able to configure months", inject(function ($compile, $rootScope) {
    ...
    it("Should be able to set and retrieve a value", inject(function ($compile, $rootScope) {
        var $scope = $rootScope.$new();
        $scope.value = "";
        console.log("1");
    ...
    it("Should be able to set start label", inject(function ($compile, $rootScope) {
        var $scope = $rootScope.$new();
        var datepicker = $compile('<uif-datepicker ng-model="value"></uif-datepicker>')($scope);
        $scope.$digest();
    ...
    it("Should be able to set placeholder", inject(function ($compile, $rootScope) {
        var $scope = $rootScope.$new();
        var datepicker = $compile('<uif-datepicker ng-model="value"></uif-datepicker>')($scope);
        $scope.$digest();
        // verify default value
